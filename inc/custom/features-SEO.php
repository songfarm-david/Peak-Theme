    ...
    <div class="entry-content">
        ...
        <div class="feature-item-container">
            ...
            <article class="feature-item">
                ...
                <!--image here-->
                <svg class="feature-icon">
                    <use xlink:href="#outreach" />
                </svg>
                <p>It’s not enough to just <a href="<?php echo get_permalink( '2376' ); ?>">create great content</a> - you’ve got to get it out there to make a difference in your SEO. Through effective Keyword Research and On-Page SEO, we make sure your hard-won content is being <em>seen</em> and making an impact on your traffic and search rankings.</p>
            </article>
            <article class="feature-item">
