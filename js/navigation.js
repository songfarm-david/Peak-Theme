...
/*
 * Adds accessibility enhancements to navigation menu
 */
(function ($) {
   ...
   function initMainNavigation( container ) {
      ...
      // Create dropdown button, append font-awesome icons and screen reader text
      // put after menu items with children (sub-menu)
      ...
      /*
       * Trigger dropdown menu toggle and manage aria text
       */
