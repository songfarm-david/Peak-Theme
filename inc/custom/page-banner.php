<article id="page-banner" class="hero">
    <div>
        ...
        /** if Web Dev page */
        if ( is_page( '1741' ) ) : ?>
        <h2 class="banner-heading banner-page-text">Ready for a website that works for your business?</h2>
        ...
        <h2 class="banner-heading banner-page-text">Elevate your online presence and start seeing results</h2>
