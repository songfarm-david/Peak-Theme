...
(function ($) {
  ...
  function initMainNavigation(container) {
    ...
    var dropdownButton = $('<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false }).append($('<i />', { 'class': 'fa fa-angle-down', 'aria-hidden': 'true' })).append($('<span />', { 'class': 'screen-reader-text', text: peakScreenReaderText.expand }));
    ...
    //.addClass( 'toggled' )
    .attr('aria-expanded', 'false').find('.screen-reader-text').text(peakScreenReaderText.expand);
  ...
  (function () {
    ...
    function toggleFocusClassTouchScreen() {
      if ('none' === $('.menu-toggle').css('display')) {
        ...
        siteNavigation.find('.menu-item-has-children > a, .page_item_has_children > a').on('touchstart.peak', function (e) {
